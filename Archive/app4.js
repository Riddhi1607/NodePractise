...
app.route('/api/v1/tours/:id').get(getTourById).patch(patchTour).delete(deleteTour)

const userRouter = express.Router();
userRouter.route('/api/v1/users').get(getAllUsers).post(createUser)
userRouter.route('/api/v1/users/:id').get(getUserById).patch(patchUser).delete(deleteUser)
